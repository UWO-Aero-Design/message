...
goog.exportSymbol('proto.Recallibrate', null, global);
 ...
 * @constructor
 */
proto.Recallibrate = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.Recallibrate, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.Recallibrate.displayName = 'proto.Recallibrate';
}
 ...
 * @const
 */
proto.Command.repeatedFields_ = [5,6,7];
...
proto.Command.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    recallibrateList: jspb.Message.toObjectList(msg.getRecallibrateList(),
    proto.Recallibrate.toObject, includeInstance)
  };
...
proto.Command.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new proto.Recallibrate;
      reader.readMessage(value,proto.Recallibrate.deserializeBinaryFromReader);
      msg.addRecallibrate(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.Command.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getRecallibrateList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      7,
      f,
      proto.Recallibrate.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated Recallibrate recallibrate = 7;
 * @return {!Array<!proto.Recallibrate>}
 */
proto.Command.prototype.getRecallibrateList = function() {
  return /** @type{!Array<!proto.Recallibrate>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Recallibrate, 7));
};


/**
 * @param {!Array<!proto.Recallibrate>} value
 * @return {!proto.Command} returns this
*/
proto.Command.prototype.setRecallibrateList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 7, value);
};


/**
 * @param {!proto.Recallibrate=} opt_value
 * @param {number=} opt_index
 * @return {!proto.Recallibrate}
 */
proto.Command.prototype.addRecallibrate = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 7, opt_value, proto.Recallibrate, opt_index);
};
 ...
 * @return {!proto.Command} returns this
 */
proto.Command.prototype.clearRecallibrateList = function() {
  return this.setRecallibrateList([]);
};
 ...
 * @return {!Object}
 */
proto.Recallibrate.prototype.toObject = function(opt_includeInstance) {
  return proto.Recallibrate.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.Recallibrate} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.Recallibrate.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.Recallibrate}
 */
proto.Recallibrate.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.Recallibrate;
  return proto.Recallibrate.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.Recallibrate} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.Recallibrate}
 */
proto.Recallibrate.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.Sensor} */ (reader.readEnum());
      msg.setSensor(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.Recallibrate.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.Recallibrate.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.Recallibrate} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.Recallibrate.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSensor();
  if (f !== 0.0) {
    writer.writeEnum(
 ...
 * @return {!proto.Sensor}
 */
proto.Recallibrate.prototype.getSensor = function() {
  return /** @type {!proto.Sensor} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.Sensor} value
 * @return {!proto.Recallibrate} returns this
 */
proto.Recallibrate.prototype.setSensor = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};
